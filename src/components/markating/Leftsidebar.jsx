...
const Leftsidebar = () => {
    ...
    return (
        <div style={{ color: "black" }}>
            ...
            <p> Gainers & Losers<br/>
                {moment(date, 'DD-MM-YYYY HH:mm:ss', true).format("DD-MM-YYYY HH:mm:ss A")}<br/>
                <Button onClick={() => usetops("Top")} variant="success" > TOP GAINERS</Button> &nbsp;
                <Button variant="danger" onClick={() => usetops("Los")}>TOP LOSERS</Button></p>
            </div>

            {tops == "Los" ?
            <div className='divrow' style={{ color: "red" }}>
